...
insert into patient ( id, first_name, last_name, telephone_number, email, patient_number, date_of_birth, address_id, married)
            values ( 901, 'Piotr', 'Kowalski', '+48 987 765 543', 'mail@test.com', '1', '1999-01-01', 902, true);
